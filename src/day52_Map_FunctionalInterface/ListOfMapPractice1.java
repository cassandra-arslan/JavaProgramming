...
//    1.1 Create a data structure that can contain all the given maps above
        ...
        // If you keep as LinkedHashMap you must cast like this:
        // scrumsTeams.addAll((Collections<? extends LinkedHashMap<String, String>>) Arrays.asList((LinkedHashMap)(scrumTeam3, scrumTeam4, scrumTeam5));
